...
import { StaticWebAppTypeStep } from "./StaticWebAppTypeStep";
...
export async function createStaticWebApp(
  ...
  promptSteps.push(new StaticWebAppTypeStep());
  ...
  await wizard.prompt();
  if (wizardContext.initializeLogicApp) {
    return createStaticWebAppWithLogicApp(context);
  }
...
export async function createStaticWebAppWithLogicApp(
  ...
  const folderName: string =
    wizardContext.newStaticWebAppName || "default_folder_name";
